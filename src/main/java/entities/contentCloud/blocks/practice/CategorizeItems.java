...
public class CategorizeItems extends CommonPracticeBlock {
    public String task;
    public List<Category> category;
    public static String url = ENDPOINT_BLOCKS + ENDPOINT_BLOCKS_PRACTICE + ENDPOINT_BLOCK_CATEGORIZE_ITEMS;

    public CategorizeItems(){
